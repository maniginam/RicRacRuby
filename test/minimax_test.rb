...
class MinimaxTest < Minitest::Test
  ...
  def test_one_box_left
    ...
    minimax.score_boxes(Board.new(board), player, 0)
    assert_equal ['X', 'O', 'X', 0, 'O', 'O', 'O', 'X', 'X'], minimax.board_scores
    assert_equal 3, minimax.choose_best_box
  end
  ...
  def test_two_boxes_left
    ...
    assert_equal 5, minimax.choose_best_box
  end
  ...
  def test_three_boxes_left
    ...
    assert_equal 2, minimax.choose_best_box
  end
  def test_four_boxes_left
    ...
    assert_equal 6, minimax.choose_best_box
  end
  ...
  def test_five_boxes_left
    ...
    assert_equal 7, minimax.choose_best_box
  end
  ...
  def test_six_boxes_left
    ...
    minimax = Minimax.new(board, player)
    minimax.score_boxes(Board.new(board), player, 0)
    minimax.board_scores = ['X', 0, 7, 0, 'O', 0, 7, 0, 'X']
    ...
    assert_equal 0, box_7_score
    assert_equal minimax.board_scores, minimax.board_scores
  end
